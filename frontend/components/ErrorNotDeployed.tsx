    ...
    <div className="grid w-full gap-4 mx-auto font-semibold bg-none">
      <div className="col-span-full mx-20">
        <p className="text-4xl leading-relaxed">
          ...
          <span className="font-mono bg-white">NightlyReflection.sol</span> Contract
          Not Deployed on{" "}
        ...
        <p className="text-xl leading-relaxed mt-8">
          ...
          from the ABI directory. To
          deploy <span className="font-mono bg-white">NightlyReflection.sol</span> on
